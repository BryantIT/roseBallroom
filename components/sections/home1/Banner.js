          ...
          <div className='swiper-wrapper'>
            <SwiperSlide className='swiper-slide'>
              <div className='main-slider__img'>
                <img
                  src='assets/images/resources/main-slider-img-1-1.jpg'
                  alt=''
                />
              </div>
            ...
            <SwiperSlide className='swiper-slide'>
              <div className='main-slider__img'>
                <img
                  src='assets/images/resources/main-slider-img-1-2.jpg'
                  alt=''
                />
              </div>
              <div className='main-slider__shape-1'>
            ...
            <SwiperSlide className='swiper-slide'>
              <div className='main-slider__img'>
                <img
                  src='assets/images/resources/main-slider-img-1-3.jpg'
                  alt=''
                />
              </div>
              <div className='main-slider__shape-1'>
